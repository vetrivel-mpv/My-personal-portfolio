      ...
      <div className="max-w-7xl mx-auto space-y-10">
        ...
        <div className="flex flex-col lg:flex-row lg:items-end justify-between gap-6">
          ...
          <div className="flex flex-wrap items-center gap-3 self-start lg:self-end pb-2">
            <button
              ...
              className="px-4 py-2.5 rounded-xl text-xs font-mono font-bold tracking-wider uppercase bg-gradient-to-r from-sky-600 to-indigo-600 hover:from-sky-500 hover:to-indigo-500 text-white shadow-md shadow-sky-600/20 transition-all flex items-center gap-2 cursor-pointer hover:scale-[1.02]"
            >
              <Download size={14} />
        ...
        {activeTab === "countries" && (
          <div className="space-y-6 animate-fadeIn">
            ...
            <div className="p-6 md:p-8 rounded-2xl bg-slate-50 border border-slate-200 text-left space-y-6 shadow-xs">
              
              <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 border-b border-slate-200 pb-4">
                <div className="space-y-1">
                  <div className="flex items-center gap-2 text-xl md:text-2xl font-extrabold text-slate-950 font-sans">
                ...
                <div className="md:col-span-4 space-y-3">
                  ...
                  <div className="flex flex-wrap gap-2">
                    {activeHighlight.keyClientMatches.map((client, idx) => (
                      <span 
                        key={idx}
                        className="px-3 py-1.5 rounded-xl bg-white border border-slate-200 text-xs font-mono font-bold text-slate-800"
                      >
                        {client}
                      </span>
                    ))}
                  ...
                  <div className="pt-4">
                    <button
                      onClick={onOpenResume}
                      className="w-full py-2.5 rounded-xl text-xs font-mono font-bold tracking-wider uppercase bg-sky-600 hover:bg-sky-500 text-white transition-all flex items-center justify-center gap-2 cursor-pointer shadow-xs"
                    >
                      <Bot size={14} />
        ...
        {activeTab === "checklist" && (
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 animate-fadeIn">
            {TELECOM_SKILL_CHECKLIST.map((group, idx) => (
              <div 
                key={idx}
                className="p-5 rounded-2xl bg-slate-50 border border-slate-200 text-left space-y-3 shadow-xs"
              >
                <div className="text-xs font-mono font-bold text-sky-700 uppercase tracking-wider border-b border-slate-200 pb-2">
                  {group.category}
                </div>
        ...
        {activeTab === "fastfacts" && (
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 animate-fadeIn text-left">
            ...
            <div className="p-6 rounded-2xl bg-slate-50 border border-slate-200 space-y-4 shadow-xs">
              <div className="text-xs font-mono font-bold text-sky-700 uppercase tracking-wider flex items-center gap-2">
                <Cpu size={15} />
            ...
            {/* Awards Card */}
            <div className="p-6 rounded-2xl bg-slate-50 border border-slate-200 space-y-4 shadow-xs">
              <div className="text-xs font-mono font-bold text-amber-800 uppercase tracking-wider flex items-center gap-2">
                <Award size={15} />
              ...
              <div className="space-y-3">
                <div className="p-3 rounded-xl bg-amber-50 border border-amber-200 space-y-1">
                  <div className="text-xs font-bold text-amber-950 flex items-center justify-between">
                    ...
                    <span className="text-[10px] font-mono text-amber-800">Capgemini Engineering</span>
                  </div>
                ...
                <div className="p-3 rounded-xl bg-indigo-50 border border-indigo-200 space-y-1">
                  <div className="text-xs font-bold text-indigo-950 flex items-center justify-between">
                    ...
                    <span className="text-[10px] font-mono text-indigo-800">Capgemini ER&D</span>
                  </div>
                  <p className="text-[11px] text-slate-700">
                ...
                <div className="p-3 rounded-xl bg-emerald-50 border border-emerald-200 space-y-1">
                  <div className="text-xs font-bold text-emerald-950 flex items-center justify-between">
                    ...
                    <span className="text-[10px] font-mono text-emerald-800">Cognizant</span>
                  </div>
                  <p className="text-[11px] text-slate-700">
                ...
                <div className="p-3 rounded-xl bg-sky-50 border border-sky-200 space-y-1">
                  <div className="text-xs font-bold text-sky-950 flex items-center justify-between">
                    ...
                    <span className="text-[10px] font-mono text-sky-800">Tech Mahindra</span>
                  </div>
                  <p className="text-[11px] text-slate-700">
