        ...
        <div className="flex items-center gap-1.5 sm:gap-2">
          ...
          {onOpenResume && (
            <button
              onClick={onOpenResume}
              id="printPdfBtn"
              title="Open Resume & Export Clean PDF"
            ...
            <div className="pt-2 border-t border-slate-200 dark:border-slate-850 space-y-2">
              ...
              <div className="flex gap-2">
                ...
                {onOpenResume && (
                  <button
                    onClick={() => { setMobileMenuOpen(false); onOpenResume(); }}
                    className="flex-1 py-2 rounded-xl text-xs bg-slate-100 dark:bg-slate-900 border border-slate-200 dark:border-slate-800 text-slate-700 dark:text-slate-300 flex items-center justify-center gap-1.5 cursor-pointer"
                  >
                    <Printer size={13} />
                    <span>Print CV</span>
                  </button>
