  ...
  const handleSendMessage = async (textToSend: string) => {
    ...
    try {
      ...
      const errorMsg: Message = {
        id: `err-${Date.now()}`,
        role: "assistant",
        content: "✨ **Vetriebot Knowledge Summary**:\n\n- 💼 **Primary Role**: Principal Telecom QA Lead & BSS/OSS Solutions Consultant | Agile Delivery Manager\n- ✈️ **Global Mobility & Sponsorship**: Seeking Work Visa Sponsorship • 100% Relocation Ready (Singapore 🇸🇬, UK 🇬🇧, USA 🇺🇸, Switzerland 🇨🇭, Luxembourg 🇱🇺)\n- 📡 **Domain Experience**: 10+ Years across Mobile OSS/BSS, Nokia WING 10M+ Subs Migration, Singleview Billing, Diameter Gy/Ro, and AT&T IoT\n- ⚙️ **Core Tech Stack**: Node.js, Next.js, TypeScript, Playwright, Postman, TM Forum Open APIs, Python, Docker\n- 🏆 **Major Achievement**: 50% Manual testing effort reduction and 30% defect escape reduction with zero P1/P2 defect leakage\n- 📜 **Certifications**: AWS Certified Cloud Practitioner, Oracle Certified Web Component Developer (OCWCD), Google Python Automation, IIIT-B SDC16\n\nFeel free to connect with Vetrivel directly at **vetrivelm02@gmail.com** or via LinkedIn!"
      };
